                ...
                <div>
                    ...
                    <div>
                        <div className="magicmed">
                            <div style={{ overflow: 'hidden', marginTop: '15px' }}>
                                <div className = "pop">
                                    <a className="themedname" href="https://github.com/Steven7926/PillDispenserMobile" ><b>MagicMeds</b> </a>
                                    <a href="https://github.com/Steven7926/PillDispenserMobile" > <img src={magicmeds} className="pillicon" alt="MagicMeds Logo" /></a>
                                </div>
                        ...
                        <div style={{ float: 'left' }}>
                            <div class="onlysocks">
                                <div style={{ marginTop: '15px' }}>
                                    <div className= "pop">
                                        <a className="themedname" href="https://github.com/Steven7926/OnlySocks" ><b>OnlySocks</b> </a>
                                        <a href="https://github.com/Steven7926/OnlySocks" > <img src={sock} style={{ width: '10vh', marginRight: '10px', float: 'right' }} alt="OnlySock Logo" /></a>
                                    </div>
                                    <div>
                    ...
                    <div className="contactmanager">
                        <div style={{ overflow: 'hidden', marginTop: '15px' }}>
                            <div style={{ float: 'left'}}>
                                <div className="pop">
                                    <a className="themedname" href="https://github.com/Steven7926/ContactManager" ><b>Conatct Manager</b> </a>
                                </div>
                                <div>
                            ...
                            <div style={{ marginRight: '5vh', float: "right" }}>
                                <div className="pop">
                                    <a className="themedname" href="https://github.com/Steven7926/EventManager/tree/Final" ><b>Event Manager</b> </a>
                                </div>
                                <div>
